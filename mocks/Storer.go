...
// CalculatePrice provides a mock function with given fields: _a0, _a1, _a2, _a3, _a4
func (_m *Storer) CalculatePrice(_a0 context.Context, _a1 int, _a2 int, _a3 string, _a4 string) (int, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4)

	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int, int, string, string) (int, error)); ok {
		return rf(_a0, _a1, _a2, _a3, _a4)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int, int, string, string) int); ok {
